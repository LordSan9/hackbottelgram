...
keyboard = [
  ...
  [
    Button.url("المطور", "https://t.me/IIlAndylII")
    ]
]
...
async def op(event):
  ...
  if not event.is_private:
    ...
    legendbye = [
      [
        Button.url("دوس هنا", f"https://t.me/oyurl")
        ]
      ]
...
async def users(event):
  async with bot.conversation(event.chat_id) as x:
      ...
      try:
        ...
        await event.respond("ارسل المشكله الى لحلها- @IIlAndylII\n**LOGS**\n" + str(e))
...
async def start(event):
    keyboard = [
      ...
      [
        Button.url("المالك", "https://t.me/IIlAndylII")
        ]
    ]
...
print(" لقد تم تنصيب البوت بنجاح.     للمساعده راسل المعرف التالي. @IIlAndylII")
